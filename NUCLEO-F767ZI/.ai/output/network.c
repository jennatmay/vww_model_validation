...
#define AI_NETWORK_MODEL_SIGNATURE     "4891a46addafa8dea3a612b011c2724b"
...
#define AI_TOOLS_DATE_TIME   "Mon Oct 28 23:36:43 2024"
...
/* Array#1 */
AI_ARRAY_OBJ_DECLARE(
  dense_0_output_array, AI_ARRAY_FORMAT_FLOAT|AI_FMT_FLAG_IS_IO,
  NULL, NULL, 1, AI_STATIC)
/* Array#2 */
AI_ARRAY_OBJ_DECLARE(
...
AI_NETWORK_OBJ_DECLARE(
  ...
  AI_TENSOR_LIST_IO_OBJ_INIT(AI_FLAG_NONE, AI_NETWORK_OUT_NUM, &dense_0_output),
  ...
  ai_network* net_ctx, const ai_network_params* params)
{
  ...
  if (ai_platform_get_activations_map(g_network_activations_map, 1, params)) {
    ...
    dense_0_output_array.data = AI_PTR(g_network_activations_map[0] + 4);
    dense_0_output_array.data_start = AI_PTR(g_network_activations_map[0] + 4);
  ...
  ai_network* net_ctx, const ai_network_params* params)
{
  ...
  if (ai_platform_get_weights_map(g_network_weights_map, 1, params)) {
    ...
    dense_0_bias_array.data = AI_PTR(g_network_weights_map[0] + 0);
    dense_0_bias_array.data_start = AI_PTR(g_network_weights_map[0] + 0);
    
    dense_0_weights_array.format |= AI_FMT_FLAG_CONST;
    dense_0_weights_array.data = AI_PTR(g_network_weights_map[0] + 4);
    dense_0_weights_array.data_start = AI_PTR(g_network_weights_map[0] + 4);
