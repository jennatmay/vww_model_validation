...
#define AI_NETWORK_2_ORIGIN_MODEL_NAME   "vww_96"
...
#define AI_NETWORK_2_IN_1_FORMAT      (AI_BUFFER_FORMAT_FLOAT)
#define AI_NETWORK_2_IN_1_HEIGHT      (96)
#define AI_NETWORK_2_IN_1_WIDTH       (96)
#define AI_NETWORK_2_IN_1_CHANNEL     (3)
#define AI_NETWORK_2_IN_1_SIZE        (27648)
#define AI_NETWORK_2_IN_1_SIZE_BYTES  (110592)
...
#define AI_NETWORK_2_OUT_1_FORMAT      (AI_BUFFER_FORMAT_FLOAT)
#define AI_NETWORK_2_OUT_1_CHANNEL     (2)
#define AI_NETWORK_2_OUT_1_SIZE        (2)
#define AI_NETWORK_2_OUT_1_SIZE_BYTES  (8)

/******************************************************************************/
#define AI_NETWORK_2_N_NODES (57)
