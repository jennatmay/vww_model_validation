...
/******************************************************************************/
#define AI_LINEAR_MODEL_NAME          "linear"
#define AI_LINEAR_ORIGIN_MODEL_NAME   "linear"

/******************************************************************************/
#define AI_LINEAR_ACTIVATIONS_ALIGNMENT   (4)
#define AI_LINEAR_INPUTS_IN_ACTIVATIONS   (4)
#define AI_LINEAR_OUTPUTS_IN_ACTIVATIONS  (4)

/******************************************************************************/
#define AI_LINEAR_IN_NUM        (1)

AI_DEPRECATED
#define AI_LINEAR_IN \
  ai_linear_inputs_get(AI_HANDLE_NULL, NULL)

#define AI_LINEAR_IN_SIZE { \
  AI_LINEAR_IN_1_SIZE, \
}
#define AI_LINEAR_IN_SIZE_BYTES { \
  AI_LINEAR_IN_1_SIZE_BYTES, \
}
#define AI_LINEAR_IN_1_FORMAT      (AI_BUFFER_FORMAT_FLOAT)
#define AI_LINEAR_IN_1_CHANNEL     (1)
#define AI_LINEAR_IN_1_SIZE        (1)
#define AI_LINEAR_IN_1_SIZE_BYTES  (4)

/******************************************************************************/
#define AI_LINEAR_OUT_NUM       (1)

AI_DEPRECATED
#define AI_LINEAR_OUT \
  ai_linear_outputs_get(AI_HANDLE_NULL, NULL)

#define AI_LINEAR_OUT_SIZE { \
  AI_LINEAR_OUT_1_SIZE, \
}
#define AI_LINEAR_OUT_SIZE_BYTES { \
  AI_LINEAR_OUT_1_SIZE_BYTES, \
}
#define AI_LINEAR_OUT_1_FORMAT      (AI_BUFFER_FORMAT_FLOAT)
#define AI_LINEAR_OUT_1_CHANNEL     (1)
#define AI_LINEAR_OUT_1_SIZE        (1)
#define AI_LINEAR_OUT_1_SIZE_BYTES  (4)

/******************************************************************************/
#define AI_LINEAR_N_NODES (1)
 ...
 * @ref ai_linear_create. Both the activations memory buffer 
 ...
 */
AI_API_ENTRY
ai_error ai_linear_create_and_init(
 ...
 */
AI_API_ENTRY
ai_buffer* ai_linear_inputs_get(
 ...
 */
AI_API_ENTRY
ai_buffer* ai_linear_outputs_get(
  ai_handle network, ai_u16 *n_buffer);
 ...
 * header generated by the code generation tool. See AI_LINEAR_*
 * defines into file @ref linear.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
