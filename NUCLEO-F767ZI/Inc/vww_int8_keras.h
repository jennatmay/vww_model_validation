/**
  ...
  ******************************************************************************
  */
#ifndef AI_VWW_INT8_KERAS_H
#define AI_VWW_INT8_KERAS_H

#include "vww_int8_keras_config.h"
#include "ai_platform.h"

/******************************************************************************/
#define AI_VWW_INT8_KERAS_MODEL_NAME          "vww_int8_keras"
#define AI_VWW_INT8_KERAS_ORIGIN_MODEL_NAME   "vww_96"

/******************************************************************************/
#define AI_VWW_INT8_KERAS_ACTIVATIONS_ALIGNMENT   (4)
#define AI_VWW_INT8_KERAS_INPUTS_IN_ACTIVATIONS   (4)
#define AI_VWW_INT8_KERAS_OUTPUTS_IN_ACTIVATIONS  (4)

/******************************************************************************/
#define AI_VWW_INT8_KERAS_IN_NUM        (1)

AI_DEPRECATED
#define AI_VWW_INT8_KERAS_IN \
  ai_vww_int8_keras_inputs_get(AI_HANDLE_NULL, NULL)

#define AI_VWW_INT8_KERAS_IN_SIZE { \
  AI_VWW_INT8_KERAS_IN_1_SIZE, \
}
#define AI_VWW_INT8_KERAS_IN_SIZE_BYTES { \
  AI_VWW_INT8_KERAS_IN_1_SIZE_BYTES, \
}
#define AI_VWW_INT8_KERAS_IN_1_FORMAT      (AI_BUFFER_FORMAT_FLOAT)
#define AI_VWW_INT8_KERAS_IN_1_HEIGHT      (96)
#define AI_VWW_INT8_KERAS_IN_1_WIDTH       (96)
#define AI_VWW_INT8_KERAS_IN_1_CHANNEL     (3)
#define AI_VWW_INT8_KERAS_IN_1_SIZE        (27648)
#define AI_VWW_INT8_KERAS_IN_1_SIZE_BYTES  (110592)

/******************************************************************************/
#define AI_VWW_INT8_KERAS_OUT_NUM       (1)

AI_DEPRECATED
#define AI_VWW_INT8_KERAS_OUT \
  ai_vww_int8_keras_outputs_get(AI_HANDLE_NULL, NULL)

#define AI_VWW_INT8_KERAS_OUT_SIZE { \
  AI_VWW_INT8_KERAS_OUT_1_SIZE, \
}
#define AI_VWW_INT8_KERAS_OUT_SIZE_BYTES { \
  AI_VWW_INT8_KERAS_OUT_1_SIZE_BYTES, \
}
#define AI_VWW_INT8_KERAS_OUT_1_FORMAT      (AI_BUFFER_FORMAT_FLOAT)
#define AI_VWW_INT8_KERAS_OUT_1_CHANNEL     (2)
#define AI_VWW_INT8_KERAS_OUT_1_SIZE        (2)
#define AI_VWW_INT8_KERAS_OUT_1_SIZE_BYTES  (8)

/******************************************************************************/
#define AI_VWW_INT8_KERAS_N_NODES (57)


AI_API_DECLARE_BEGIN

/*!
 * @defgroup vww_int8_keras
...
AI_DEPRECATED
AI_API_ENTRY
ai_bool ai_vww_int8_keras_get_info(
 ...
 * @ref ai_vww_int8_keras_create. Both the activations memory buffer 
 ...
 * using @ref ai_vww_int8_keras_get_error
 */
AI_API_ENTRY
 ...
 */
AI_API_ENTRY
ai_error ai_vww_int8_keras_create_and_init(
 ...
 */
AI_API_ENTRY
ai_buffer* ai_vww_int8_keras_inputs_get(
 ...
 */
AI_API_ENTRY
ai_buffer* ai_vww_int8_keras_outputs_get(
  ai_handle network, ai_u16 *n_buffer);
 ...
 * header generated by the code generation tool. See AI_VWW_INT8_KERAS_*
 * defines into file @ref vww_int8_keras.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
 ...
 */
AI_API_ENTRY
ai_i32 ai_vww_int8_keras_forward(
  ai_handle network, const ai_buffer* input);

AI_API_DECLARE_END

#endif /* AI_VWW_INT8_KERAS_H */
