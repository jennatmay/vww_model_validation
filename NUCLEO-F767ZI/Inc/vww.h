...
#include "vww_config.h"
#include "ai_platform.h"

/******************************************************************************/
#define AI_VWW_MODEL_NAME          "vww"
#define AI_VWW_ORIGIN_MODEL_NAME   "vww_96_int8"

/******************************************************************************/
#define AI_VWW_ACTIVATIONS_ALIGNMENT   (4)
#define AI_VWW_INPUTS_IN_ACTIVATIONS   (4)
#define AI_VWW_OUTPUTS_IN_ACTIVATIONS  (4)

/******************************************************************************/
#define AI_VWW_IN_NUM        (1)

AI_DEPRECATED
#define AI_VWW_IN \
  ai_vww_inputs_get(AI_HANDLE_NULL, NULL)

#define AI_VWW_IN_SIZE { \
  AI_VWW_IN_1_SIZE, \
}
#define AI_VWW_IN_SIZE_BYTES { \
  AI_VWW_IN_1_SIZE_BYTES, \
}
#define AI_VWW_IN_1_FORMAT      (AI_BUFFER_FORMAT_S8)
#define AI_VWW_IN_1_HEIGHT      (96)
#define AI_VWW_IN_1_WIDTH       (96)
#define AI_VWW_IN_1_CHANNEL     (3)
#define AI_VWW_IN_1_SIZE        (27648)
#define AI_VWW_IN_1_SIZE_BYTES  (27649)

/******************************************************************************/
#define AI_VWW_OUT_NUM       (1)

AI_DEPRECATED
#define AI_VWW_OUT \
  ai_vww_outputs_get(AI_HANDLE_NULL, NULL)

#define AI_VWW_OUT_SIZE { \
  AI_VWW_OUT_1_SIZE, \
}
#define AI_VWW_OUT_SIZE_BYTES { \
  AI_VWW_OUT_1_SIZE_BYTES, \
}
#define AI_VWW_OUT_1_FORMAT      (AI_BUFFER_FORMAT_S8)
#define AI_VWW_OUT_1_CHANNEL     (2)
#define AI_VWW_OUT_1_SIZE        (2)
#define AI_VWW_OUT_1_SIZE_BYTES  (2)

/******************************************************************************/
#define AI_VWW_N_NODES (43)
 ...
 * @ref ai_vww_create. Both the activations memory buffer 
 ...
 * header generated by the code generation tool. See AI_VWW_*
 * defines into file @ref vww.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
