...
#define AI_NETWORK_1_ORIGIN_MODEL_NAME   "vww_96_int8"
...
#define AI_NETWORK_1_IN_1_SIZE        (27648)
...
#define AI_NETWORK_1_OUT_1_CHANNEL     (2)
#define AI_NETWORK_1_OUT_1_SIZE        (2)
#define AI_NETWORK_1_OUT_1_SIZE_BYTES  (2)
